        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-center mb-4 md:mb-0">
            ...
            <ul className="flex flex-wrap justify-center md:justify-start gap-4 mb-4">
              ...
              <li><a href="#work" className="hover:text-emerald-300">Work</a></li>
              <li><a href="#reviews" className="hover:text-emerald-300">Reviews</a></li>
              <li><a href="#contact" className="hover:text-emerald-300">Contact me</a></li>
            </ul>
            ...
            <ul className="flex flex-wrap justify-center  gap-6">
              <li>
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-300">
              ...
              <li>
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-300">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
              ...
              <li>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-300">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
              ...
              <li>
                <a href="https://gmail.com" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-300">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
