        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-center mb-4 md:mb-0">
            ...
            <ul className="flex flex-wrap justify-center gap-6">
              ...
              <li>
                <a href="https://linkedin.com/siddardha-karumuri-3bb6b4298" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-300">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
              ...
              <li>
                <a href="https://instagram.com/teja__sid_darth__03" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-300">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
